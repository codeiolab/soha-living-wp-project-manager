                ...
                <li  v-for="comment in comments" :key="'tasks-comments-'+comment.id" :class="'comment-li pm-fade-out-'+comment.id">
                    <div  :class="lcommentLiBodyClass(comment.edit_mode)">
                        <div class="comment-header">
                            ...
                            <div v-if="!comment.edit_mode && can_edit_comment(comment)" class="comment-action-arrow">
                                <span class="icon-pm-more-options pm-font-size-16" @click.prevent="showActionMenu(comment)"></span>
                        ...
                        <div v-if="!comment.edit_mode" class="pm-comment-content">
                            ...
                            <div v-html="showLoomAndFigmaPreview(comment.content, 'list-comments')"></div>
