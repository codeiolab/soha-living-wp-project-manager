            ...
            <div v-else class="popup-mask">
                ...
                <div class="popup-container">
                    ...
                    <div v-activity-load-more class="popup-body">
                        <div class="pm-single-task-header">
                            ...
                            <div class="task-complete-incomplete" :class="{ 'disable': can_complete_task(task) }">
                                <a 
                                    ...
                                    v-if="task.status" 
                                    href="#" 
                                    @click.prevent="singleTaskDoneUndone()"
                                    v-tooltip.top-center="__( 'Click to mark the task as incompleted.', 'wedevs-project-manager' )" 
                                >
                                ...
                                <a 
                                    ...
                                    href="#" 
                                    @click.prevent="singleTaskDoneUndone()"
                                    v-tooltip.top-center="__( 'When the task is done, click to mark it as completed.', 'wedevs-project-manager' )" 
                                >
                                    <span class="bb-icon-check bb-icon-l pm-font-size-16" v-if="!show_spinner_status"></span>
                                    <span class="pm-spinner" v-if="show_spinner_status"></span>
                            ...
                            <div class="task-modal-top-right-action">
                                <div class="pm-single-task-actions">
                                    <span @click.prevent="PM_Vars.is_pro ? singleTaskLockUnlock(task) : ''">
                                        <i class="bb-icon-lock-alt bb-icon-l" v-if="task.meta.privacy == '0' || typeof task.meta.privacy == 'undefined'"></i>
                                        <i class="bb-icon-lock-open bb-icon-l" v-if="task.meta.privacy == '1'"></i>
                                    </span>
                                    <span @click.prevent="taskDuplicate(task.id)"><i class="bb-icon-duplicate bb-icon-l"></i></span>
                                    <span @click.prevent="copyUrl(task)"><i class="bb-icon-link bb-icon-l"></i></span>
                                </div>
                                ...
                                <span @click.prevent="closePopup()"><i class="bb-icon-arrow-right bb-icon-l"></i></span>
                            </div>
                        </div>
                        ...
                        <div class="task-list-titlle-privacy">
                            ...
                            <div class="options-wrap actions-wrap">
                                <div class="task-privacy-wrap context" v-if="can_edit_task(task) && user_can('view_private_task')">
                                    <h3 class="label"><span>{{ __( 'Privacy', 'wedevs-project-manager' ) }}</span></h3>
                        ...
                        <div class="options-wrap actions-wrap">
                            <div class="task-due-date-wrap context">
                                <h3 class="label">
                                    <span>{{ __( 'Due Date', 'wedevs-project-manager' ) }}</span>
                                    <i
                                        v-tooltip:top-center="__('You can fix a date for when this task</br>is planned to be accomplished.', 'wedevs-project-manager')"
                                        class="info-icon"
                                    >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div 
                                            ...
                                            v-if="!task.start_at.date && !task.due_date.date"
                                        >
                                            <span>{{ __( 'No date found!', 'wedevs-project-manager' ) }}</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="task-type-wrap context">
                                <task-type :task="task" />
                            </div>
                        ...
                        <div class="actions-wrap">
                            <div class="description-wrap">
                                <h3 class="label" v-if="!task.description.content">
                        ...
                        <div class="single-task-discuss-activity">
        ...
        methods: {
            ...
            updateTaskElement (task, callback) {
                ...
                var update_data  = {
                        ...
                        'type_id': this.isEmpty( task.type ) ? false : task.type.id,
